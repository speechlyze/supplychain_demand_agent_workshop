...
async def agents() -> JSONResponse:
    ...
    return JSONResponse({
        ...
        "edges": [
            ...
            {"id": "da-vs",         "source": "demand_analyst", "target": "oracle_vs",   "label": "search_demand_reports"},
            {"id": "pa-vs",         "source": "policy_agent",   "target": "oracle_vs",   "label": "get_planner_policy"},
            {"id": "pa-store",      "source": "policy_agent",   "target": "agent_store", "label": "get_user_memory"},
            {"id": "sup-saver",     "source": "supervisor",     "target": "saver",       "label": "checkpoint", "dashed": True},
        ],
    })
