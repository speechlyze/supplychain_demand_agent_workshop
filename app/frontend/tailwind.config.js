...
export default {
  ...
  theme: {
    extend: {
      ...
      keyframes: {
        "pulse-glow-store": {
          "0%":   { boxShadow: "inset 0 0 0 0 rgba(6, 214, 160, 0.0)", backgroundColor: "rgba(6, 214, 160, 0.18)" },
          "100%": { boxShadow: "inset 0 0 0 999px rgba(6, 214, 160, 0.0)", backgroundColor: "transparent" },
        },
      },
      animation: {
