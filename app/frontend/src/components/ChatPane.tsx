          ...
          {chat.length === 0 && (
            <div className="text-text-secondary text-sm space-y-3">
              <p className="text-text-primary">
                Ask the planner-assistant a question. Each turn fires the
                supervisor; the right pane fills in per-agent traces while
                the bottom panes light up tables and edges as tools execute.
              </p>
