...
like *user preferences*, *org policies*, *persona facts* — anything an
...
> else here you'll create a *parallel* empty store and the seeded
...
→ **[Part 5 — `AsyncOracleSaver`](part-5-saver.md)** — the *other* memory, scoped to a single thread.
